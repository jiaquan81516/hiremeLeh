const RESOURCES = [
    ...
    items: [
      {
        ...
        description: 'A comprehensive spreadsheet to track all your internship applications — company, role, status, deadlines, contacts and notes all in one place.',
    ...
    items: [
      {
        ...
        description: 'A crowdsourced collection of real interview questions asked at Singapore tech companies — sorted by company, role, and question type.',
    ...
    items: [
      {
        ...
        description: "Singapore's official government job portal. Best for local company listings and government-linked roles. Where HiremeLeh pulls its live data from.",
      ...
      {
        title: 'LinkedIn Jobs',
        description: 'Best for MNC internships, global companies, and networking with recruiters. Set job alerts for your target roles.',
      ...
      {
        title: 'Glassdoor',
        description: 'Company reviews, salary data, and interview experiences. Great for researching a company before applying or interviewing.',
      ...
      {
        title: 'NodeFlair',
        description: 'Singapore-focused tech salary transparency platform. See verified salaries for software engineering and data roles.',
  ...
  },
  {
    ...
    items: [
      {
        title: 'LeetCode',
        description: 'Essential for technical interviews. Start with Easy problems, focus on Arrays, Strings, and HashMaps first. Most SG tech companies test this.',
      ...
      {
        title: 'freeCodeCamp',
        description: 'Free full-stack web development curriculum. Great for building projects to put on your resume — HTML, CSS, JavaScript, Node.js, and more.',
      ...
      {
        title: 'Kaggle',
        description: 'Free data science courses and competitions. Build a portfolio of data projects. Kaggle certificates are recognized by Singapore employers.',
  ...
  return (
    <div>
      <p style={{ fontSize: 13, color: '#888', marginBottom: '1.5rem' }}>
        ...
        <a href="mailto:jiaquan81516@gmail.com" style={{ color: '#185FA5' }}>Submit it here.</a>
      </p>

      {RESOURCES.map(section => (
        <div key={section.category} style={{ marginBottom: '2rem' }}>
          <h2 style={{ fontSize: 13, fontWeight: 600, color: '#888', textTransform: 'uppercase', letterSpacing: '0.5px', marginBottom: '0.75rem' }}>
            {section.category}
          </h2>
                  ...
                  <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', gap: 8, marginBottom: 6 }}>
                    <div style={{ display: 'flex', alignItems: 'center', gap: 8, flexWrap: 'wrap' }}>
                      ...
                      <span style={{
                        ...
                        background: item.tagBg, color: item.tagColor, fontWeight: 600,
                      }}>
                        {item.tag}
                      </span>
                    </div>
                    <span style={{ fontSize: 12, color: '#185FA5', whiteSpace: 'nowrap', marginTop: 2 }}>Open →</span>
                  </div>

                  <p style={{ fontSize: 13, color: '#555', lineHeight: 1.5, marginBottom: item.credit ? 8 : 0 }}>
                    {item.description}
                  </p>
